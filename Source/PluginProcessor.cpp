...
bool VashEQAudioProcessor::acceptsMidi() const {
...
bool VashEQAudioProcessor::producesMidi() const {
...
bool VashEQAudioProcessor::isMidiEffect() const {
#if JucePlugin_IsMidiEffect
    return true;
#else
    return false;
...
double VashEQAudioProcessor::getTailLengthSeconds() const {
    return 0.0;
}

int VashEQAudioProcessor::getNumPrograms() {
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
    // so this should be at least 1, even if you're not really implementing programs.
}

int VashEQAudioProcessor::getCurrentProgram() {
    return 0;
}

void VashEQAudioProcessor::setCurrentProgram(int index) {
}

const juce::String VashEQAudioProcessor::getProgramName(int index) {
    return {};
}

void VashEQAudioProcessor::changeProgramName(int index, const juce::String &newName) {
}

//==============================================================================
void VashEQAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock) {
...
bool VashEQAudioProcessor::isBusesLayoutSupported(const BusesLayout &layouts) const {
#if JucePlugin_IsMidiEffect
...
void VashEQAudioProcessor::processBlock(juce::AudioBuffer<float> &buffer, juce::MidiBuffer &midiMessages) {
...
//==============================================================================
bool VashEQAudioProcessor::hasEditor() const {
...
juce::AudioProcessor *JUCE_CALLTYPE createPluginFilter() {
    return new VashEQAudioProcessor();
}
